...
mkdir("../dataset/processed_j"+num2str(100/decimationRate)+"/lp_residual/");
mkdir("../dataset/processed_j"+num2str(100/decimationRate)+"/force/");
...
for i = {files.name}
    ...
    if strlength(i) == 13 
        ...
        csvwrite("../dataset/processed_j"+num2str(100/decimationRate)+"/lp_residual/"+i,mat_processed);
        csvwrite("../dataset/processed_j"+num2str(100/decimationRate)+"/force/"+i,mat);
    end
end
